...
def test_get_all_labels():
    ...
    assert get_all_labels(html_string, 'img') == ['<img class="logotipo" src="resources/img/calidad/logo.png" alt="">', '<img src="resources/svg/simbolo_eliminar_44.svg" alt="">', '<img src="resources/img/menu/comida1.png" alt="">', '<img class="iconos" src="resources/img/social_media/fb.png" alt="">', '<img class="iconos" src="resources/img/social_media/twitter2.png">', '<img class="iconos" src="resources/img/social_media/instagramm.png" alt="">', '<img src="resources/img/calidad/logo_rickMorty.JPG">']
